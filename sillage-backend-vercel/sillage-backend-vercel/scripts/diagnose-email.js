...
async function main() {
  ...
  switch (command) {
    ...
    default:
      ...
      console.log('   node diagnose-email.js test tu-email@gmail.com  - Enviar email de prueba');
      console.log('   node diagnose-email.js gmail                    - Ayuda específica Gmail');
      console.log('   node diagnose-email.js full                     - Diagnóstico completo');
      break;
  }
}

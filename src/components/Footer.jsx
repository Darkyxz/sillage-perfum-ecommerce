        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-8 md:mb-12">
          ...
          <div className="lg:col-span-1 text-center">
            <div className="mb-4 md:mb-6">
              <h3 className="text-xl md:text-2xl font-display font-bold text-sillage-gold-warm mb-2 md:mb-3">Sillage Perfum</h3>
            ...
            <div className="flex space-x-3 md:space-x-4 justify-center">
              <a href="#" className="w-8 h-8 md:w-10 md:h-10 bg-secondary border border-border rounded-full flex items-center justify-center hover:bg-primary hover:border-primary transition-all duration-300 shadow-sm hover:shadow-md group">
                <Instagram className="w-3 h-3 md:w-4 md:h-4 text-sillage-gold-dark group-hover:text-primary-foreground transition-colors" />
              </a>
              <a href="#" className="w-8 h-8 md:w-10 md:h-10 bg-secondary border border-border rounded-full flex items-center justify-center hover:bg-primary hover:border-primary transition-all duration-300 shadow-sm hover:shadow-md group">
                <Facebook className="w-3 h-3 md:w-4 md:h-4 text-sillage-gold-dark group-hover:text-primary-foreground transition-colors" />
              </a>
              <a href="#" className="w-8 h-8 md:w-10 md:h-10 bg-secondary border border-border rounded-full flex items-center justify-center hover:bg-primary hover:border-primary transition-all duration-300 shadow-sm hover:shadow-md group">
                <Twitter className="w-3 h-3 md:w-4 md:h-4 text-sillage-gold-dark group-hover:text-primary-foreground transition-colors" />
              </a>
            </div>
          </div>
          ...
          <div className="text-center">
            <h4 className="text-base md:text-lg font-semibold text-sillage-gold-warm mb-3 md:mb-4">Enlaces Rápidos</h4>
          ...
          {/* Información */}
          <div className="text-center">
            <h4 className="text-base md:text-lg font-semibold text-sillage-gold-warm mb-3 md:mb-4">Información</h4>
            <ul className="space-y-2 md:space-y-3">
          ...
          {/* Contacto */}
          <div className="text-center">
            <h4 className="text-base md:text-lg font-semibold text-sillage-gold-warm mb-3 md:mb-4">Contacto</h4>
            <div className="space-y-2 md:space-y-3">
              <div className="flex items-start space-x-2 md:space-x-3 justify-center">
                <MapPin className="w-3 h-3 md:w-4 md:h-4 text-sillage-gold-bright mt-0.5 flex-shrink-0" />
                <div className="text-center">
              ...
              <div className="flex items-center space-x-2 md:space-x-3 justify-center">
                <Phone className="w-3 h-3 md:w-4 md:h-4 text-sillage-gold-bright flex-shrink-0" />
                <p className="text-sillage-gold-dark text-sm">+56 9 1234 5678</p>
              </div>
              
              <div className="flex items-center space-x-2 md:space-x-3 justify-center">
                <Mail className="w-3 h-3 md:w-4 md:h-4 text-sillage-gold-bright flex-shrink-0" />
                <p className="text-sillage-gold-dark text-sm">info@sillageperfum.cl</p>
              </div>
              
              <div className="flex items-start space-x-2 md:space-x-3 justify-center">
                <Clock className="w-3 h-3 md:w-4 md:h-4 text-sillage-gold-bright mt-0.5 flex-shrink-0" />
                <div className="text-center">

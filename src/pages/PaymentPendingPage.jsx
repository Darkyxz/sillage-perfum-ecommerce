...
const PaymentPendingPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center py-12">
      ...
      >
        <Card className="glass-effect border-amber-500/50 text-center">
          <CardHeader>
            <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-gradient-to-r from-amber-500 to-yellow-500 mb-4">
